...
const Page: React.FC = () => {
  ...
  return (
    <main>
      <div className="mb-2 text-2xl font-bold text-slate-50">ログイン</div>
      ...
      >
        <div className="space-y-1">
          <label htmlFor="email" className="block font-bold text-slate-50">
        ...
        <div className="space-y-1">
          <label htmlFor="password" className="block font-bold text-slate-50">
